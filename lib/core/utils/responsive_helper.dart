...
class ResponsiveHelper {
  ...
  static double getProductCardAspectRatio(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    if (width > 1200) return 0.55; // Desktop - wider cards, more height
    if (width > 600) return 0.6; // Tablet - more height for content
    return 0.58; // Mobile - taller cards to fit content without overflow
  }
